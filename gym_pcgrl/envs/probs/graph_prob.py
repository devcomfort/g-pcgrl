...
class GraphProb(Problem):
    ...
    def render(self, m):
        ...
        nx.draw(gr, node_size=400, labels=labels, with_labels=True, node_color='lightblue', font_size=10,
                font_color='black', font_weight='bold', arrows=True, connectionstyle="arc3,rad=0.2")
        plt.show()
